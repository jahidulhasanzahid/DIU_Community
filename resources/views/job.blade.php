 ...
 <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="row">
            <div class="col-lg-12 col-xl-6 order-lg-3 order-xl-2">
                ...
                <!-- post comment -->
                <div class="card mb-g">
                    @foreach($allJobPost as $allComPost)
                    <div class="card-body pb-0 px-4">
                        <div class="d-flex flex-row pb-3 pt-2  border-top-0 border-left-0 border-right-0">
                            ...
                            <h5 class="mb-0 flex-1 text-dark fw-500">
                                ...
                                <br>
                                <small class="m-0 l-h-n">
                                    Job Type: <b>{{ $allComPost->jobType }}</b>
                                </small>
                            </h5>
                        ...
                        <div class="d-flex align-items-center demo-h-spacing py-3">
                            ...
                            @if($allComPost->userID == Auth::user()->id)    
                                <a href="{{ url('job-edit',$allComPost->id) }}" class="btn btn-sm btn-success">Edit</a>
                                <form class="form-inline" action="{!! route('job-delete', $allComPost->id) !!}" method="post">
                                @csrf
