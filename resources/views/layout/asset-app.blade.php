...
<body class="mod-bg-1 ">
                ...
                <div class="page-content-wrapper">
                    ...
                    <footer class="page-footer" role="contentinfo">
                        <div class="d-flex align-items-center flex-1 text-muted">
                            <span class="hidden-md-down fw-700">2019 © legendsaidi by&nbsp;<a href='https://www.legendsaidi.com/' class='text-primary fw-500' title='gotbootstrap.com' target='_blank'>legendsaidi.com</a></span>
                        </div>
                        <div>
    ...
    <script>
        ...
        <script src="{{asset('frontend/js/app.bundle.js')}}"></script>
        ...
        <script src="{{asset('frontend/js/statistics/peity/peity.bundle.js')}}"></script>
        <script src="{{asset('frontend/js/statistics/flot/flot.bundle.js')}}"></script>
        <script src="{{asset('frontend/js/statistics/easypiechart/easypiechart.bundle.js')}}"></script>
        <script src="{{asset('frontend/js/datagrid/datatables/datatables.bundle.js')}}"></script>
        <script>
            /* defined datas */
